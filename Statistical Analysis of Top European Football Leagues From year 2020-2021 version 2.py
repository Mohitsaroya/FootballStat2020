...
class FootballAnalysis:
    ...
    def choices_display_general(self, df):
        print("1. Table\n"
              "2. Line Chart\n"
              "3. Bar Chart\n")
        display_choice = int(input("Choose the format: "))
        
        if display_choice == 1:
            
        
        
    def choices_display_leagues(self, df):
        print("1. Table\n"
              "2. Line Chart\n"
              "3. Bar Chart\n")
        display_choice = int(input("Choose the format: "))
        ...
        if display_choice == 1:
            print(df[["Football League", "Win", "Draw", "Loss"]])
    ...
    def display_general_details(self):    
        print("1. League Names"
            ...
            "3. Goals per Match"
            "4. win/draw/loss comparison"
            "5. Home goals vs away goals"
            "6. Back")
    ...
    def plot_goals_per_match(self, df):
        ...
        self.display_choices()
        choice = int(input("Choose the format: "))
